...
namespace UIFramework.Runtime.AppEvent
{
    public class Dispatcher
    {
        ...
        public void RegisteCallback(Type type, Action<object> callback, bool exclude = false, object listener = null)
        {
            if(exclude)
            {
        ...
        public void UnregisterCallback(Type type, System.Action<object> callback)
        {
            if(callback == null)
            {
                _callbacks.Remove(type);
